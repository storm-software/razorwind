...
# Razorwind - Shiki Theme Generator

**Razorwind - Shiki Theme Generator** is a package that can create themes for the [Shiki](https://github.com/shikijs/shiki) library.
...
import myTheme from "./shiki-themes/my-theme.json";
...
Run `nx build shiki` to build the library.

### Running unit tests

Run `nx test shiki` to execute the unit tests via [Vitest](https://vitest.dev/).
