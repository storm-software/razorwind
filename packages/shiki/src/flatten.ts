...
import type { FlatToken, ShikiPluginOptions } from "./types";
...
/**
 * Flatten DTCG token trees into rows helpful for {@link ShikiPluginOptions.mapTheme}.
 */
export function flattenTokens(
  tokens: Tokens | Record<string, Tokens>,
  options: Pick<ShikiPluginOptions, "includeTypes"> = {}
): FlatToken[] {
